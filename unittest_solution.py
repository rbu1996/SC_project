...
class SoultionTestCase(unittest.TestCase):
    ...
    def test_find_all_positions(self):
        ...
        res = [(('A', 'A'), ((1, 3), (3, 3))), (('A', 'A'), ((1, 3), (3, 1))), (('A', 'A'), ((1, 3), (1, 5))), (('A', 'A'), ((1, 3), (1, 1))), (('A', 'A'), ((1, 3), (3, 5))), (('A', 'A'), ((3, 3), (3, 1))), (('A', 'A'), ((3, 3), (1, 5))), (('A', 'A'), ((
            3, 3), (1, 1))), (('A', 'A'), ((3, 3), (3, 5))), (('A', 'A'), ((3, 1), (1, 5))), (('A', 'A'), ((3, 1), (1, 1))), (('A', 'A'), ((3, 1), (3, 5))), (('A', 'A'), ((1, 5), (1, 1))), (('A', 'A'), ((1, 5), (3, 5))), (('A', 'A'), ((1, 1), (3, 5)))]
        self.assertEquals(set(res), set(
            [i for i in self.solution.find_all_positions(blocks, grid)]))

    def test_cal_reflect_start(self):
        point = (1, 2, 1, 1)
        reflect_point = (1, 2, 1, -1)
        self.assertEquals(
            reflect_point, self.solution.cal_reflect_start(point))
    ...
    def test_get_intersect_point(self):
        ...
        start_point = (0, 1, 1, 1)
        res = (0, 1, 1, 1)
        self.assertEquals(res, self.solution.get_intersect_point(
            intersect_grid, lazor_points, start_point))

    def test_get_intersect_grid(self):
        intersect_point = (6, 3, 1, -1)
        grid = (7, 3)
        self.assertEquals(
            grid, self.solution.get_intersect_grid(intersect_point))

    def test_check_position(self):
        position = {(3, 1): self.solution.Block('A'),
                    (5, 1): self.solution.Block('B')}
        grid = {(1, 3), (3, 3), (3, 1), (5, 1), (1, 1), (5, 3)}
        start_points = [(0, 1, 1, 1)]
        goal_points = {(3, 4)}
        self.assertEquals(False, self.solution.check_position(
            position, grid, start_points, goal_points))
